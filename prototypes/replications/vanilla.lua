...
repltech_ore('iron-ore', 1, {internal_name = '26-ore-iron'})
repltech_ore('copper-ore', 1, {internal_name = '29-ore-copper'})
repltech_ore('coal')
repltech_ore('stone')
repltech_ore('wood')
--This is per unit of liquid, so it should be low
repltech_ore('water', 0.02)
repltech_ore('crude-oil', 0.1)
...
repltech_item('uranium-ore', 'ore', {{target = 'ore', type = 'var', multiplier = 6}, {target = 'sulfuric-acid', type = 'item', multiplier = 10}}, nil, {internal_name = '92-ore-uranium'})
...
repltech_recipe('long-handed-inserter', 'device4')
...
repltech_item_table({replsub_recipe('medium-electric-pole'), replsub_recipe('big-electric-pole')}, 'device3', 'medium-electric-pole', {localized_name = {'technology-name.repl-poles'}})
...
repltech_item('space-science-pack', 'science', {{target = 'rocket-part', type = 'recipe', multiplier = 0.1}, {target = 'satellite', type = 'item', multiplier = 0.001}}, {{target = 'rocket-part', type = 'recipe'}, {target = 'satellite', type = 'item'}}, {tier = 5})
