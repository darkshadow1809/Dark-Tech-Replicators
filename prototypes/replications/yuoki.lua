...
repltech_item_table({replsub_recipe("y_slag_granulate_recipe"), replsub_recipe("y_slag_brick_recipe"), replsub_recipe("y_tile_slagbricks_recipe"), replsub_recipe("y_tile_slagpattern_recipe"), replsub_recipe("y_tile_slagfilled_recipe")}, "shape", {target = "y-slag", type = "item"}, {localized_name = {"technology-name.repl-shape-slag"}})
...
repltech_recipe("y-smelt-crush-res1-recipe", "exotic", {localized_name = {"technology-name.repl-unicomp-refined"}, tier = 2, research_multiplier = 0.5})
repltech_recipe("y-unicomp-raw-recipe", "exotic", {localized_name = {"technology-name.repl-unicomp-shaped"}, tier = 2})

--Fuelnium
repltech_item_table({
	replsub_item("y-res2", {target = "ore", type = "var", multiplier = 4}),
	replsub_recipe("y-crush-fuel-raw-recipe")
	}, "exotic", nil, {localized_name = {"technology-name.repl-yfuel-ore"}, tier = 1})
repltech_recipe("y-smelt-crush-res2-recipe", "exotic", {localized_name = {"technology-name.repl-yfuel-refined"}, tier = 2, research_multiplier = 0.5})
repltech_recipe("y-raw-fuelnium-recipe", "exotic", {localized_name = {"technology-name.repl-yfuel-shaped"}, tier = 2})

--Mixed
repltech_recipe("y-mixing-rich-recipe", "exotic", {localized_name = {"technology-name.repl-mixed-refined"}, tier = 2, research_multiplier = 0.5})
repltech_recipe("y-press-richdust-recipe", "exotic", {localized_name = {"technology-name.repl-mixed-shaped"}, tier = 2})
repltech_recipe("y-orange-stuff_recipe", "exotic", {localized_name = {"technology-name.repl-mixed-other"}, tier = 2})
...
repltech_item("y-battery-single-use2", "device2", {target = "y-battery-singleuse2-recipe", type = "recipe"}, {target = "y-battery-singleuse1-recipe", type = "recipe"}, {localized_name = {"technology-name.repl-ybattery"}, internal_name = "y-battery-b"})
repltech_recipe("y-battery-single-use3-recipe", "device3", {internal_name = "y-battery-c"})
...
--Accumulators
repltech_item_table({replsub_recipe("y-accumulator-m-recipe"), replsub_recipe("y-accumulator-b-recipe")}, "device4", "y-accumulator-b-recipe", {localized_name = {"technology-name.repl-quant-accum"}})
repltech_item_table({replsub_recipe("y-accumulator-mt2-recipe"), replsub_recipe("y-accumulator-bt2-recipe")}, "device4", "y-accumulator-b-recipe", {localized_name = {"technology-name.repl-yadvanced-accum"}})
...
repltech_item_table({replsub_recipe("y-rare-wall-basic-recipe"), replsub_recipe("y-rare-wall-adv-recipe")}, "device4", "y-rare-wall-basic-recipe", {localized_name = {"technology-name.repl-yadvanced-wall"}})
repltech_recipe("y-wall-forcefield-recipe", "device4")
repltech_recipe("y_wall22_hardic_recipe", "device4")

--Turrets
repltech_item_table({replsub_recipe("y_laser_onhwall_recipe"), replsub_recipe("y_laser_mk1_recipe")}, "device4", "y_laser_onhwall_recipe", {localized_name = {"technology-name.repl-yadvanced-laser"}})
repltech_item_table({replsub_recipe("y-gun-turret-mk2-recipe"), replsub_recipe("y-gun-turret-mk3-recipe")}, "device4", "y-gun-turret-mk2-recipe", {localized_name = {"technology-name.repl-yadvanced-turret"}})

--Ammo
repltech_recipe("y-bullet-case-recipe", "alloy")
repltech_recipe("y-ammo-acid-medium-recipe", "device3", {internal_name = "y-acid-ammo"})
